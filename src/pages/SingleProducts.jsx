      ...
      <DIV>
        ...
        <div className="middle">
          ...
          <div className="dabba">
            ...
            <p>
              🎁 Free Dr. Vaidya Plant Protein with prepaid cart value{">"}
              ₹12,000
            </p>
            <p>
              🎁 Free Nutrabay Stringer with prepaid cart value {">"} ₹8,000
            </p>
            <p>
          ...
          <div className="maingray">
            ...
            <div className="gray">
              ...
              <p>
                All our products are far from expiry, and procured directly from
                the brand or authorized importers of the brand.
              </p>
            </div>
          </div>
