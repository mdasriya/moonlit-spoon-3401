...
const Footer1 = () => {
  return <Box bgColor="#06181C" marginLeft={{sm:'12%',base:'12%',md:'0%',xl:'0%'}} paddingLeft="10%" color="lightgray" paddingTop="30px" paddingBottom="30px">
    ...
    <Box width="50%" marginTop="20px" display="flex" flexDirection={{sm:"column",md:"row",base:"column"}}>
      <Input marginRight="20px" marginBottom={{sm:'20px',base:"20px"}} width={["95%","75%","60%","60%"]} borderColor="#2FB0DA" ></Input>
